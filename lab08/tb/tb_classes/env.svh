...
//------------------------------------------------------------------------------
    ...
    fifomult2024_agent class_fifomult2024_agent_h;
    fifomult2024_agent module_fifomult2024_agent_h;
...
//------------------------------------------------------------------------------
    ...
    function void build_phase(uvm_phase phase);
        ...
        fifomult2024_agent_config class_agent_config_h;
        fifomult2024_agent_config module_agent_config_h;
        ...
        uvm_config_db #(fifomult2024_agent_config)::set(this, "class_fifomult2024_agent_h*",
            "config", class_agent_config_h);
        uvm_config_db #(fifomult2024_agent_config)::set(this, "module_fifomult2024_agent_h*",
            "config", module_agent_config_h);

        // create the agents
        class_fifomult2024_agent_h  = fifomult2024_agent::type_id::create("class_fifomult2024_agent_h",this);
        module_fifomult2024_agent_h = fifomult2024_agent::type_id::create("module_fifomult2024_agent_h",this);
