 ...
 */
module fifomult2024_tpgen_module(fifomult2024_bfm bfm);
...
//------------------------------------------------------------------------------
	...
	initial begin
		...
		repeat (5000) begin : random_loop
			...
			bfm.send_op(idata_in_packet.A, idata_in_packet.A_parity, idata_in_packet.B, idata_in_packet.B_parity, op_set);
		end : random_loop
	end // initial begin

endmodule : fifomult2024_tpgen_module
